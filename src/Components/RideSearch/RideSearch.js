                                    ...
                                    <Row>
                                        ...
                                        <Col md={12}>
                                            <div className="input-field">
                                                <input className="px-4 py-3 mb-2 text-black border border-transparent rounded" type="text" maxlength="11" placeholder="Enter pick-up location"/>
                                        ...
                                        <Col md={12}>
                                            <div className="input-field">
                                                <input type="password" className="px-4 py-3 mb-2 text-black border border-transparent rounded" placeholder="Enter drop-off location"/>
                                                <div className="input-icon">
                                                    <i className="fa fa-map-marker i-envelope" aria-hidden="true"></i>
                                                </div>
                                            </div>
